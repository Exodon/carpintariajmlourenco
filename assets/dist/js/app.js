...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./swiper */ "./assets/src/js/swiper.js");


var modal = function () {
  // select the open-btn button
  var openBtn = document.getElementById('open-btn'); // select the modal-background

  var modalBackground = document.getElementById('modal-background'); // select the close-btn 

  var closeBtn = document.getElementById('close-btn'); // shows the modal when the user clicks open-btn
