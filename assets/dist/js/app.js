...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modal */ "./assets/src/js/modal.js");
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./swiper */ "./assets/src/js/swiper.js");
...
var modal = function () {
  ...
  function a11yModalSystem() {
    var modalElement = document.querySelectorAll('[data-js="modal"]');

    if (modalElement) {
      modalElement.forEach(function (modalWrapper) {
        var modal = modalWrapper.querySelector("[data-modal]");
        var openBtn = modalWrapper.querySelector("[data-modal-open]");
        var closeBtn = modalWrapper.querySelector("[data-modal-close]"); // Check if you can add an attribute on a test dialog
        ...
        if (testdialog.open == true) {
          ...
          // browser doesn’t support the element
          // Overlay
  ...
  function closeIcon() {
    $('.close-icon').on('click', function () {
      $(this).addClass('clicked'); // do whatever you want to do
    });
  }
  ...
  document.addEventListener("DOMContentLoaded", a11yModalSystem, closeIcon, closeIconEffect);
}();
